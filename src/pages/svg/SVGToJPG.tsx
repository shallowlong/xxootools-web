...
const SVGToJPG = () => {
  ...
  // 将SVG转换为JPG
  const convertSvgToJPG = async (result: SVGResult) => {
  ...
  return (
    <ToolLayout
      categoryId="svg"
      toolId="svg-to-jpg"
      title={t('categories.svg.tools.svg-to-jpg.name')}
      description={`（${t('categories.svg.tools.svg-to-jpg.description')}）`}
    >
              ...
              {svgResults.map(result => (
                <div key={result.id} className="border rounded-lg p-4 flex flex-col gap-3">
                  <div className="flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded p-4 h-40">
                    <img 
                      src={result.jpgUrl || result.svgPreview} 
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-xs font-medium">
                      {result.isConverting ? (
                        ...
                        <span className="text-green-500">SVG → JPG</span>
                      ) : (
                  ...
                  <div className="flex justify-end gap-2 mt-auto">
                    {!result.isConverting && result.jpgUrl && (
                      <Button 
